...
$login =  $_SESSION['login'];
 ...
 try {
  ...
  $contagem=$conn->query("SELECT * FROM user");
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable">
            <h1>Fiscalização - Geral </h1>
            <!-- Custom tabs (Charts with tabs)-->
<?php
$tab=$conn->query("SELECT * FROM history");
while ($ficha=$tab->fetch() ){
  ...
  <table class="table table-bordered">
    ...
    <tbody>
      <tr>
        <td><?php echo $ficha['history_name']?></td>
        <td><?php echo $ficha['history_last_name']?></td>
            <td><?php echo $ficha['history_day']?></td>
            <td><?php echo $ficha['history_join']?></td>
            <td><?php echo $ficha['history_left']?></td>
            <td><?php  $val = $ficha['history_check'];
            if ($val == 0){
            ?>
